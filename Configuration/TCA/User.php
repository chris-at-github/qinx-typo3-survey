...
$GLOBALS['TCA']['tx_qxsurvey_domain_model_user'] = array(
	...
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, email, name, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_qxsurvey_domain_model_user.pid=###CURRENT_PID### AND tx_qxsurvey_domain_model_user.sys_language_uid IN (-1,0)',
			),
		),
